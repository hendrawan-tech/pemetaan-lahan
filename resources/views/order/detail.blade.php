                                    ...
                                    <div class="col-sm-6">
                                        @if (Auth::user()->role == 'Pembeli')
                                            <div>
                                                ...
                                                <span
                                                    class="text-600 text-110 text-blue align-middle">{{ $order->payment->user->name }}</span>
                                            </div>
                                            <div class="text-grey-m2">
                                                <div class="my-1">
                                                    No HP : {{ $order->payment->user->phone }}
                                                </div>
                                                <div class="my-1">
                                                    Alamat : {{ $order->payment->user->address }}
                                                </div>
                                            </div>
                                        @else
                                            <div>
                                                <span class="text-sm text-grey-m2 align-middle">Pembeli:</span>
                                                <span
                                                    class="text-600 text-110 text-blue align-middle">{{ $order->user->name }}</span>
                                            </div>
                                            <div class="text-grey-m2">
                                                <div class="my-1">
                                    ...
                                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                        ...
                                        <div class="text-grey-m2">
                                            ...
                                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                    class="text-600 text-90">No. Transaksi:</span> #{{ $order->code }}
                                            </div>

                                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                    class="text-600 text-90">Tanggal:</span> {{ $order->created_at }}
                                            </div>
                                ...
                                <div class="mt-4">
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tbody class="text-95 text-secondary-d3">
                                                @foreach ($order->item as $key => $data)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        ...
                                                        <td class="text-secondary-d2">
                                                            {{ Helper::price($data->product->price * $data->quantity) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                    ...
                                    <div class="d-flex bg-light justify-content-end">
                                        <div class="d-flex align-items-center bgc-primary-l3 p-2">
                                            ...
                                            <div class="">
                                                <b
                                                    class="text-150 text-lg text-success-d3 opacity-2">{{ Helper::price($order->total) }}</b>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tbody class="text-95 text-secondary-d3">
                                                @foreach ($order->massage as $key => $data)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        <td>
                                    ...
                                    @if (Auth::user()->role == 'Tengkulak')
                                        @if ($order->status == 'Menunggu Pembayaran' || $order->status == 'Proses')
                                            <hr>
                                    ...
                                    @if ($order->status == 'Menunggu Pembayaran' || $order->status == 'Proses')
                                        @if ($order->image)
                                            ...
                                            <div class="text-center">
                                                <img src="{{ asset($order->image) }}" width="500" alt="">
                                            </div>
                                        @else
                                            @if (Auth::user()->role == 'Pembeli')
                                                <hr />
